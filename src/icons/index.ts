...
import { ReactComponent as Trash } from "./trash.svg?react";
...
import { ReactComponent as ToolsManagement } from "./settings-star.svg?react";
import { ReactComponent as ArrowLeft } from "./left-arrow.svg?react";
import { ReactComponent as SendNotif } from "./send-notif.svg?react";
import { ReactComponent as Filter } from "./filter.svg?react";
import { ReactComponent as Pdf } from "./pdf.svg?react";
import { ReactComponent as Picture } from "./picture.svg?react";
import { ReactComponent as Update } from "./update.svg?react";
import { ReactComponent as Scrap } from "./SCRAP.svg?react";
